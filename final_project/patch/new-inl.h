...
public:
                       ...
                       const std::vector<TBlob> &aux_args)
  {
    ...
    CHECK_EQ(this->param_.kernel[0], this->param_.kernel[1]); // square kernel
    ...
    CHECK_EQ(wshape[0], this->param_.num_filter); // support 1 group
                        ...
                        const std::vector<TBlob> &aux_args)
  {
    ...
    CHECK_EQ(0,1) << "Backward pass unimplemented";
  }
...
public:
                  ...
                  std::vector<TShape> *aux_shape) const override
  {
    ...
    CHECK_EQ(param_.kernel.ndim(), 2U) << "Only support 2D kernels";
    CHECK_EQ(param_.kernel[0], param_.kernel[1]) << "Only support square kernels";
