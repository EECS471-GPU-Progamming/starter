...
ADD_LDFLAGS = -L/sw/pkgs/arc/cuda/11.6.2/lib64/stubs/

# the additional compile flags you want to add
ADD_CFLAGS = -I/sw/pkgs/arc/cudnn/11.6-v8.4.1/include/ -fpermissive
...
# add path to intel library, you may need it for libmkl_intel_lp64.a, if you did not add the path
# to environment variable
USE_INTEL_PATH = /sw/pkgs/arc/intel/2022.1.2/mkl/2022.0.2
